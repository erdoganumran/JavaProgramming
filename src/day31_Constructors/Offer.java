...
public class Offer {
    ...
    public void setInfo(String location, String companyName, String jobTitle, int salary, boolean hasBenefit, boolean hasPTO, boolean isWFH, boolean isFullTime) {
        ...
        // if you don't have this setInfo method here, in the main method you have to call instance objects them one by one
    }

    public String toString() {// it will convert custom class object to string
        return "Offer{" +
                "location='" + location + '\'' +
