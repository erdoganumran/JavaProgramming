...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Character> chars = new ArrayList<>();// to convert string to the array list

        for (int i = 0; i < str.length(); i++) {
            chars.add( str.charAt(i) );// i will add each char to the array list chars
        }

        ArrayList<Character> letters = new ArrayList<>( chars ); // created a new array list to add all the characters
       ...
       //  specialCh.removeAll(digits);
        ...
        specialCh.removeIf(p-> Character.isLetterOrDigit(p));
